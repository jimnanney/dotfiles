...
vim.keymap.set('n', '<leader>fb', function()
  require('telescope.builtin').git_files(
  {
    git_command = { "git", "diff", "main...", "--name-only" }
  }
)
end, { desc = '[F]ind changed files in [B]ranch'})
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'ruby', 'javascript', 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'vimdoc', 'vim', 'yaml' },
  ignore_install = {},
  sync_install = true,
